...
**3a Answer.**  
\\ since the Binomial likelihood is conjugate to Beta prior, psoterior distribution for θ remains Beta distribution. 
The givens here are: \\
...
**3b Answer.**  
Give the expression (in terms of \(\alpha,\beta,y,n\)) for the posterior mean of \(\theta\). 
\\
...
**3c Answer.**  
Alternatively, we may consider using the priors below: 
\begin{align*}
